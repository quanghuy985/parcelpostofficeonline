...
public partial class ParcelPostOfficeServiceDetail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //bindGirdRepeaterServiceDetail();
    }
    protected void bindGirdRepeaterServiceDetail()
    {
        //DataTable dt;
        //ParcelPostBO parcel = new ParcelPostBO();
        //dt = parcel.getDataForParcelServiceDetail();
