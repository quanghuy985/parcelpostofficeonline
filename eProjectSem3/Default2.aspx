                                    ...
                                    <table style="width: 20px; height: 20px;">
                                        ...
                                        <tr>
                                            <td align="center" style="font-style: italic; font-family: Times New Roman;">
                                                Brief :<a href="#" id="Button1" style="font-family: Times New Roman; font-size: medium;
                                                    font-style: italic" onclick="clicker(<%#DataBinder.Eval(Container.DataItem, "newsID")%>)">
                                                    <%# DataBinder.Eval(Container.DataItem, "newsTitle")%></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                                <%# DataBinder.Eval(Container.DataItem, "newsBrief")%>...<a href="#" id="A1" style="font-style: italic"
                                                    onclick="clicker(<%#DataBinder.Eval(Container.DataItem, "newsID")%>)"> More...</a>
                                            </td>
                                        </tr>
                                        <hr />
                                    </table>
                                ...
                                <div style="float: left; width: 100%">
                                    <table style="width: 50%">
                                        <tr>
                                            ...
                                            <td align="left" valign="middle" style="width: 50%; font-size: smaller; font-style: oblique;
                                                font-family: Times New Roman;">
                                                <li><a href="#" id="Button1" style="font-family: Times New Roman; font-size: small;
                                                    font-style: italic" onclick="clicker(<%#DataBinder.Eval(Container.DataItem, "newsID")%>)">
                                ...
                                <div style="float: left; width: 30%">
                                    <table style="width: 100%; height: 141px;">
                                        <tr>
                                            ...
                                            <td align="center" style="font-style: italic; font-family: Times New Roman;">
                                                Brief :<a href="#" id="Button1" style="font-family: Times New Roman; font-style: italic;
                                                    font-size: medium" onclick="clicker(<%#DataBinder.Eval(Container.DataItem, "newsID")%>)">
                                                    <%# DataBinder.Eval(Container.DataItem, "newsTitle")%></a>
                                            </td>
                                        </tr>
                                        <hr />
